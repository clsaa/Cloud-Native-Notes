...
* 下载harbor<https://github.com/goharbor/harbor>
* 申请https证书，下载证书，将证书放到,/mnt/harbor/data/cert/server.crt，/mnt/harbor/data/cert/server.key
* 改写harbor.cfg配置文件
...
hostname = registry.dop.clsaa.com
...
harbor_admin_password = Dop123456789
...
* 改写docker-compose.yaml,主要是将数据挂载到/mnt/harbor/data
